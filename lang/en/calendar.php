...
$string['repeatfrequency'] = 'Repeat every';
$string['minutes'] = 'Minute/s';
$string['hours'] = 'Hour/s';
$string['days'] = 'Day/s';
$string['weeks'] = 'Week/s';
$string['twoweeks'] = 'Fortnight/s';
$string['months'] = 'Month/s';
$string['totalevents'] = 'Total events';
$string['years'] = 'Year/s';
$string['repeattype'] = 'Repeat type';
$string['eventdateinvalid'] = 'Invalid date requested for repeat event. Check your calendar. You have requested a repeat event on a date that does not exist. Repeat events have not been created past the invalid date.';
$string['repeat_end'] = 'Repeat until';
$string['endrepeats'] = 'End repeats';
$string['thismanyevents'] = 'After creating this many events';
$string['repeatuntil'] = 'Repeat until';
$string['invalidtimerepeatend'] = 'The date and time you selected for the end of the repeating events series is before the start date and time. The original event has been created with no repeats.';