...
$string['eventdateinvalid'] = 'Invalid date requested for repeat event. Check your calendar. You have requested a repeat event on a date that does not exist. The repeat event has not been scheduled.';